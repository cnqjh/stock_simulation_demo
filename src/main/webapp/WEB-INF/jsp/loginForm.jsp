   ...
   $(function(){
	   ...
	   $("#login-submit-btn").on("click",function(){
		   ...
		   if(!/^\w{4,20}$/.test(loginName)){
			     msg = "登录名长度必须是6~20之间";
		   }else if(!/^\w{4,20}$/.test(loginPassword)){
			     msg = "密码长度必须是6~20之间";
		   }
		   if(msg !=""){
	...
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="login.html"
				style="font-size: 22px; color: #FFF;"> 股票模拟操作管理系统
			</a>
		</div>
		<form action="login" method="post" id="loginForm">
						...
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-user"></i> <input
									...
									id="loginName" name="loginName" value="${logiName}">
							</div>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-lock"></i> <input
									...
									placeholder="密码" id="loginPassword" name="loginPassword"
									value="${loginPassword}">
							</div>
						</div>
					</div>
			...
			<div class="page-footer" style="color: #fff">
				兼容浏览器IE8+，最佳分辨率1280*800. <br>2018 @ 滕乾安 https://github.com/tengqianan
			</div>
		</form>
	</div>
